    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl w-full">
            <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Pesanan Berhasil!</h1>
                <p class="text-lg text-gray-600 mb-8">
                    Terima kasih atas pesanan Anda. Kami telah menerima pesanan Anda dan akan memprosesnya segera.
                </p>

                <!-- Order Details Card -->
                <div class="bg-linear-to-r from-indigo-50 to-purple-50 rounded-lg p-6 mb-8">
                ...
                <div class="mt-8 pt-8 border-t">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div class="flex items-start gap-3">
                            <div
                                class="shrink-0 w-8 h-8 bg-indigo-100 text-blue-600 rounded-full flex items-center justify-center font-bold">
                                1</div>
                            <div class="text-left">
                                <p class="font-semibold text-gray-900">Pesanan Dikonfirmasi</p>
                        ...
                        <div class="flex items-start gap-3">
                            <div
                                ...
                                2</div>
                            <div class="text-left">
                                <p class="font-semibold text-gray-900">Memproses Pesanan</p>
                                <p class="text-gray-600">Kami sedang menyiapkan item Anda</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div
                                ...
                                3</div>
                            <div class="text-left">
                                <p class="font-semibold text-gray-900">Dikirim & Diterima</p>
                                <p class="text-gray-600">Lacak pesanan Anda kapan saja</p>
                            </div>
                        </div>
                    </div>
                </div>
