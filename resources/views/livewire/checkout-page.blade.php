            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center">
                    <div class="flex items-center {{ $step >= 1 ? 'text-blue-600' : 'text-gray-400' }}">
                        ...
                        <span class="ml-2 font-medium">Pengiriman</span>
                    </div>
            ...
            <div class="lg:col-span-2">
                ...
                @if($step === 1)
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-6">Alamat Pengiriman</h2>
                        ...
                        @if($addresses->count() > 0)
                            <div class="mb-6">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span class="font-medium">Gunakan alamat yang tersimpan</span>
                                </label>
                            </div>
                        ...
                        @if(!$useExistingAddress || $addresses->count() === 0)
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Alamat 1 *</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Alamat 2</label>
                    ...
                    @else
                        <div class="mb-6 pb-6 border-b">
                            <div class="flex items-center justify-between bg-green-50 p-3 rounded-lg">
                                <div>
                                    <p class="text-sm font-medium text-green-800">Kupon Digunakan</p>
