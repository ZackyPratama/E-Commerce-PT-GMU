<div>
    ...
    <section class="py-16 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-8">Kategori Produk</h2>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                @foreach($categories as $category)
                    <a href="{{ route('products.index', ['category' => $category->slug]) }}" class="group">
                        ...
                        <p class="text-center text-sm text-gray-500">{{ $category->products_count }} Produk</p>
                    </a>
                @endforeach
            </div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Jaminan Kualitas</h3>
                    <p class="text-gray-600">Semua produk dipilih dengan cermat dan diuji kualitasnya</p>
                </div>
                <div class="text-center">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-indigo-100 text-blue-600 rounded-full mb-4">
                    ...
                    <p class="text-gray-600">Pengiriman cepat langsung ke alamat Anda</p>
                </div>
                <div class="text-center">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-indigo-100 text-blue-600 rounded-full mb-4">
                    ...
                    <p class="text-gray-600">Informasi pembayaran Anda aman dengan kami</p>
                </div>
            </div>
        </div>
    </section>
