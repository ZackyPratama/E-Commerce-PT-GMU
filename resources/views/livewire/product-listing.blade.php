<div class="bg-gray-50 py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Menampilkan {{ $products->total() }} produk</p>
        </div>
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-8">
            ...
            <aside class="hidden lg:block">
                <div class="sticky top-24 space-y-6">
                    ...
                    @if($search || $category || $brand || $minPrice || $featured)
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="font-semibold text-gray-900">Filter Aktif</h3>
                    ...
                    <!-- Price Range -->
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <h3 class="font-semibold text-gray-900 mb-3">Rentang Harga</h3>
                        <div class="space-y-4">
            ...
            <div class="lg:col-span-3">
                ...
                @else
                    <div class="bg-white p-12 rounded-lg shadow-sm text-center">
                        ...
                        <p class="text-gray-600 mb-4">Coba sesuaikan filter atau istilah pencarian Anda</p>
