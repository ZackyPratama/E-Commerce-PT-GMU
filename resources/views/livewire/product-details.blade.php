            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 p-8">
                ...
                <div>
                    ...
                    <div class="aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                        ...
                        @else
                            <div
                                class="w-full h-full flex items-center justify-center bg-linear-to-br from-gray-300 to-gray-400">
                ...
                <div x-show="activeTab === 'reviews'" x-cloak>
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500">Belum ada ulasan. Jadilah yang pertama memberikan ulasan untuk produk
                                ini!</p>
                        </div>
                    @endif
                </div>
