            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="border-t pt-4">
                        <p class="text-sm text-gray-600">Pelanggan Sejak</p>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-bold text-gray-900">Alamat yang Disimpan</h2>
                        @if(!$showAddressForm)
                    ...
                    @else
                        @if(!$showAddressForm)
                            <p class="text-gray-600 text-center py-4">Tidak ada alamat yang disimpan.</p>
                        @endif
                    @endif
                </div>
            </div>
